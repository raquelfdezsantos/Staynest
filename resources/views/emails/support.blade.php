...
@section('title', 'Nueva solicitud de soporte')

@section('content')
<h2 style="margin: 0 0 20px 0; color: #2c5aa0; font-size: 20px;">Nueva solicitud de soporte</h2>
...
<table style="width: 100%; margin: 20px 0; border-collapse: collapse; background: #f8f9fa; border-radius: 2px; overflow: hidden;">
    ...
    <tr>
        <td style="padding: 12px; border-bottom: 1px solid #e9ecef;"><strong>Asunto:</strong></td>
        <td style="padding: 12px; border-bottom: 1px solid #e9ecef;">{{ $data['subject'] }}</td>
    </tr>
    <tr>
